<%-- 
    Document   : home
    Created on : Apr 25, 2021, 9:51:11 AM
    Author     : wasat
--%>
...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="PendingOrder.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Pending
                            ...
                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        <img src="./images/<%=image%>" alt="Product Image" class="img-size-50">
                                    </div>
        ...
        <!-- jQuery Knob Chart -->
        <script src="admin/assests/plugins/jquery-knob/jquery.knob.min.js"></script>
        <!-- daterangepicker -->
